...
@property (nonatomic, strong) KTGIFImage *animatedImage;
...
- (void)setImage:(UIImage *)image
{
    ...
    if ([image isKindOfClass:[KTGIFImage class]] && image.images) {
        if([image.images[0] isKindOfClass:UIImage.class])
            [super setImage:image.images[0]];
        else
            [super setImage:nil];
        self.currentFrame = nil;
        self.animatedImage = (KTGIFImage *)image;
...
- (void)setAnimatedImage:(KTGIFImage *)animatedImage
{
